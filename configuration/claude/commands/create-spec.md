...
<step_metadata>
  ...
  <reads>
    - @docs/product/mission-lite.md (conditional)
    - @docs/product/tech-stack.md (conditional)
  </reads>
...
<date_determination_process>
  <primary_method>
    ...
    <process>
      1. CREATE directory if not exists: docs/specs/
      2. CREATE temporary file: docs/specs/.date-check
...
<instructions>
  IF has_file_creator:
    ...
    REQUEST: "Create directory: docs/specs/[DATE]-[SPEC-NAME]/"
  ELSE:
...
<step_metadata>
  <creates>
    - file: docs/specs/YYYY-MM-DD-spec-name/spec-lite.md
  </creates>
...
<review_request>
  ...
  - Spec Summary: @docs/specs/YYYY-MM-DD-spec-name/spec-lite.md
...
<conditional_reads>
  ...
  <manual_reads>
    <mission_lite>
      - IF NOT already in context: READ @docs/product/mission-lite.md
      - IF already in context: SKIP reading
    </mission_lite>
    <roadmap>
      - IF NOT already in context: READ @docs/product/roadmap.md
      - IF already in context: SKIP reading
    </roadmap>
    <decisions>
...
<decision_analysis>
  <review_against>
    - @docs/product/mission-lite.md (conditional)
    - @docs/product/roadmap.md (conditional)
  </review_against>
  <criteria>
...
<execution_flow>
  IF user_confirms_yes:
    REFERENCE: @~/docs/instructions/execute-tasks.md
...
<standards>
  <follow>
    - @docs/product/code-style.md
    - @docs/product/dev-best-practices.md
