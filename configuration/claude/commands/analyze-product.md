...
# Analyze Current Product & Improve Documentation
...
Setup proper product documentation into an existing codebase if missing, analyze current product state and progress.  Builds on plan-product.md
...
<context_questions>
  ...
  To properly set up documentation, I need to understand:
...
<execution_prompt>
  ...
  I'm configuring documentation for an existing product. Here's what I've gathered:
...
<summary_template>
  ...
  I've analyzed your [PRODUCT_TYPE] codebase and prepared documentation that reflects your actual implementation.
  ...
  3. Start creating specs using create-spec.md command

  Your codebase is now ready for agentic coding! 🚀
</summary_template>
