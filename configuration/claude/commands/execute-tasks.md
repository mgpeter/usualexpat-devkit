---
description: Rules to execute a task and its sub-tasks planned with a documentation workflow commands.
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
<step_metadata>
  <reads>relevant parts of docs/standards/best-practices.md if the file exists</reads>
...
<step_metadata>
  <reads>relevant parts of docs/standards/code-style.md if the file exists</reads>
