...
<data_sources>
  ...
  <fallback_sequence>
    1. @~/docs/standards/tech-stack.md
    2. @~/.claude/CLAUDE.md
    3. Cursor User Rules
  </fallback_sequence>
</data_sources>
...
<instructions>
  IF has_file_creator:
    ...
    REQUEST: "Create directory: docs/product/"
  ELSE:
    CREATE: Directory using mkdir -p docs/product/
...
<step_metadata>
  <creates>
    - file: docs/product/tech-stack.md
  </creates>
</step_metadata>
...
<step_metadata>
  <creates>
    - file: docs/product/mission-lite.md
  </creates>
...
<final_checklist>
  <verify>
    - [ ] All 5 files created in docs/product/
