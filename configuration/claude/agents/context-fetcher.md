...
description: Retrieves and extracts relevant information from documentation files. Checks if content is already in context before returning.
...
- PRDs: docs/prds/*.md, docs/features/*.md
- Technical documentation: docs/*.md, docs/architecture/*.md, docs/infrastructure/*.md
